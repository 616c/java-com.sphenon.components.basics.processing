...
public class ProcessingStringPool extends StringPoolClass {
    static protected ProcessingStringPool singleton = null;

    static public ProcessingStringPool getSingleton (CallContext cc) {
        if (singleton == null) {
            singleton = new ProcessingStringPool(cc);
        }
        return singleton;
    }
    ...
    protected ProcessingStringPool (CallContext cc) {
        super(cc);
        /*************************************************/
